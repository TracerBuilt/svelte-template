...
<div id="top" class="page" role="document">
	<header role="banner">
		...
		<div class="text-samples">
			...
			<h5 class="text1">
				<span class="swatch link rad-shadow" />
				var(--link)
			</h5>
			<h5 class="text1">
				<span class="swatch link-visited rad-shadow" />
				var(--link-visited)
			</h5>
			<h5 class="text1">
...
              <p><em>This text has added emphasis. But, it should not be displayed in a comment</em></p>-->
		...
		<section id="embedded">
			...
			<article id="embedded__svg">
				...
				<div>
					<svg width="100px" height="100px"><circle cx="100" cy="100" r="100" fill="#1fa3ec" /></svg
					>
				</div>
			</article>
			<article id="embedded__iframe">
				<header><h2>IFrame</h2></header>
				<div><iframe src="./index_files/index.html" height="300" /></div>
			</article>
		</section>
		<section id="forms">
			...
			<form>
				...
				<fieldset id="forms__checkbox">
					...
					<ul class="list list--bare">
						<li>
							<label for="checkbox1"
								><input id="checkbox1" name="checkbox" type="checkbox" checked={true} /> Choice A</label
							>
						</li>
						<li>
							<label for="checkbox2"
